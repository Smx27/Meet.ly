...
public static class ApplicationServicesExtension
{
    ...
    /// </summary>
    /// <param name="services">IServiceCollection is an interface that defines a contract
    ...
    /// <param name="config">IConfiguration is an interface in ASP.NET Core that provides
    ...
    {
        //Replacing builder with services to extend the services
