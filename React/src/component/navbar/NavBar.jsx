      ...
      <nav className="bg-[#FB6F92] dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="#" className="flex items-center">
            <h2 className="self-center text-2xl font-semibold whitespace-nowrap text-slate-900">𝑀𝑒𝑒𝓉.𝓁𝓎</h2>
          </a>
          <div className="flex md:order-2">
          <button className="bg-transparent border border-[#FFE5EC] hover:border-transparent hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
  Login
</button>
